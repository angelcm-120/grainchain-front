            ...
            <div className="card-body pt-4">
              ...
              <div className="py-9">
                <div className="d-flex align-items-center justify-content-between mb-2">
                  <span className="font-weight-bold mr-2">   <FormattedMessage id="APP.LABEL.EMAIL"/>:</span>
                  <span className="text-muted text-hover-primary">
                    {user.email}
                  </span>
                </div>
                <div className="d-flex align-items-center justify-content-between mb-2">
                  <span className="font-weight-bold mr-2">  <FormattedMessage id="APP.LABEL.PHONE"/>:</span>
                  <span className="text-muted">{user.phone}</span>
                </div>
                <div className="d-flex align-items-center justify-content-between">
                  <span className="font-weight-bold mr-2"> <FormattedMessage id="APP.LABEL.LOCATION"/>:</span>
              ...
              <div className="navi navi-bold navi-hover navi-active navi-link-rounded">
                ...
                <div className="navi-item mb-2">
                  ...
                  >
                    ...
                    <span className="navi-text font-size-lg">
                    <FormattedMessage id="APP.BUTTON.CHANGE_PASSWORD"/>
                    </span>
                    {/*
                ...
                <div className="navi-item mb-2">
                  ...
                  >
                    ...
                    <span className="navi-text font-size-lg">
                    <FormattedMessage id="APP.BUTTON.ENABLE_MFA"/>
                    </span>
                    {/*
                    <span className="navi-label">
                      <span className="label label-light-danger label-rounded font-weight-bold">
