...
export function HeaderMenu({ layoutProps }) {
    ...
    >
        ...
        <ul className={`menu-nav ${layoutProps.ulClasses}`}>
             {/*begin::1 Level*/}
             <li className={`menu-item menu-item-rel ${getMenuItemActive('/home')}`} hidden={user.roles!==1?true:false}>
                <NavLink className="menu-link" to="/home">
                    <span className="menu-text"><FormattedMessage id="GLOBAL.WORD.HOME" /></span>
                    {layoutProps.rootArrowEnabled && (<i className="menu-arrow" />)}
                </NavLink>
            </li>
            {/*begin::1 Level*/}
            <li className={`menu-item menu-item-rel ${getMenuItemActive('/dashboard')}`} hidden={user.roles!==1?true:false}>
                <NavLink className="menu-link" to="/dashboard">
                    <span className="menu-text"><FormattedMessage id="GLOBAL.WORD.DASHBOARD" /></span>
                    {layoutProps.rootArrowEnabled && (<i className="menu-arrow" />)}
                </NavLink>
            </li>
            {/*end::1 Level*/}
             ...
             {/*begin::1 Level*/}
             <li className={`menu-item menu-item-rel ${getMenuItemActive('/sandbox')}`} hidden={user.roles!==1?true:false}>
                <NavLink className="menu-link" to="/sandbox">
                    <span className="menu-text"><FormattedMessage id="GLOBAL.WORD.SANDBOX" /></span>
                    {layoutProps.rootArrowEnabled && (<i className="menu-arrow" />)}
                </NavLink>
            </li>
            {/*end::1 Level*/}
            ...
            <li
                ...
                hidden={user.roles!==1?true:false}
                >
